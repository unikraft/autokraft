...
def update_config_ports_from_readme(
    ...
    try:
        ...
        raise IndexError(f"mapping_index {mapping_index} out of range; only {len(mappings)} mapping(s) found")
    ...
    print(f"Updated {config_path} with public_port={public_port}, exposed_port={exposed_port} "
